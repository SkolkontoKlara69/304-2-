...
public class PauseManager : MonoBehaviour
{
    ...
    /// 1. lägg in public PauseManager pauseManager;
    ...
    /// 3. skriv en if-sats i den fil du vill ha funktionen som beror på om det är pausat och skriv vilkoret pauseManager.paused == false
